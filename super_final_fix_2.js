...
// STANDARDIZE NEWLINES FOR STRING MATCHING!
code = code.replace(/\r\n/g, '\n');
...
console.log("btn replaced:", code.includes('justifyContent: \'flex-end\', marginTop: 10'));
console.log("empty replaced:", code.includes('<FileText size={48}'));
