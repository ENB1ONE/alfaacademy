# 4. App.jsx
app_jsx = """import { BrowserRouter, Routes, Route, Navigate } from 'react-router-dom';
...
"""
with open("crm/src/App.jsx", "w", encoding="utf-8") as f: f.write(app_jsx)
...
"""
with open("crm/src/main.jsx", "w", encoding="utf-8") as f: f.write(main_jsx)
