...
# Find the block for router.post('/chamadas') and replace it
new_chamadas_code = """// 5. Salvar Lista de Chamada (POST)
...
text = re.sub(r'// 5\. Salvar Lista de Chamada \(POST\).*?router\.post\(\'/chamadas\'.*?\}\);\n', new_chamadas_code + "\n", text, flags=re.DOTALL)
