categories_jsx = """import React, { useState, useEffect, useContext } from 'react';
import api from '../api';
...
with open("crm/src/pages/Categories.jsx", "w", encoding="utf-8") as f:
    f.write(categories_jsx)
